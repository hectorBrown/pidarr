...
pub async fn api_v3_manualimport_get(configuration: &configuration::Configuration, folder: Option<&str>, download_id: Option<&str>, movie_id: Option<i32>, filter_existing_files: Option<bool>) -> Result<Vec<models::ManualImportResource>, Error<ApiV3ManualimportGetError>> {
