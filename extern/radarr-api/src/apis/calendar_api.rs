...
pub async fn api_v3_calendar_get(configuration: &configuration::Configuration, start: Option<String>, end: Option<String>, unmonitored: Option<bool>, tags: Option<&str>) -> Result<Vec<models::MovieResource>, Error<ApiV3CalendarGetError>> {
