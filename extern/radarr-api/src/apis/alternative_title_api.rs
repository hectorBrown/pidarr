...
pub async fn api_v3_alttitle_get(configuration: &configuration::Configuration, movie_id: Option<i32>, movie_metadata_id: Option<i32>) -> Result<Vec<models::AlternativeTitleResource>, Error<ApiV3AlttitleGetError>> {
...
pub async fn api_v3_alttitle_id_get(configuration: &configuration::Configuration, id: i32) -> Result<models::AlternativeTitleResource, Error<ApiV3AlttitleIdGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
