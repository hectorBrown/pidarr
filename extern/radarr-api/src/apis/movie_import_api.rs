...
pub async fn api_v3_movie_import_post(configuration: &configuration::Configuration, movie_resource: Option<Vec<models::MovieResource>>) -> Result<Vec<models::MovieResource>, Error<ApiV3MovieImportPostError>> {
