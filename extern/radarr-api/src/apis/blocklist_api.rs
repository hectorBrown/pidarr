...
pub async fn api_v3_blocklist_movie_get(configuration: &configuration::Configuration, movie_id: Option<i32>) -> Result<Vec<models::BlocklistResource>, Error<ApiV3BlocklistMovieGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
